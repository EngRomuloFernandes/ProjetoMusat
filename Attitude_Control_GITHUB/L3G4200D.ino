...
void getGyroValues(){
  ...
  z = ((zMSB << 8) | zLSB); 
        ...
        //updates z gyro offset if angle rate is really low!
        if (sen_data.gyro_z<1.07 && sen_data.gyro_z>-1.07){
          offset_gyro_z = offset_gyro_z*0.95+sen_data.gyro_z*0.05;
        }
        
        // load gyro values to DCM
        gyro[0] = sen_data.gyro_x;
        gyro[1] = sen_data.gyro_y;
        gyro[2] = sen_data.gyro_z - offset_gyro_z;
